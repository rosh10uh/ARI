...
namespace ARI.EVOS.Dealer.Domain.Models.Dealer.Entity
{
    ...
    public class ContactInformation : Entity<int>
    {
        ...
        private ContactInformation(string contact1, string contact2, PhoneNumber phoneNumber1, PhoneNumber phoneNumber2, string phoneExchange1, string phoneExchange2, Fax fax, Email email)
        {
            Contact1 = contact1;
            Contact2 = contact2;
        ...
        public static ContactInformation Create(string contact1, string contact2, PhoneNumber phoneNumber1, PhoneNumber phoneNumber2, string phoneExchange1, string phoneExchange2, Fax fax, Email email)
        {
            return new ContactInformation(contact1, contact2, phoneNumber1, phoneNumber2, phoneExchange1, phoneExchange2, fax, email);
        }

        public void Update(string contact1, string contact2, PhoneNumber phoneNumber1, PhoneNumber phoneNumber2, string phoneExchange1, string phoneExchange2, Fax fax, Email email)
        {
            Contact1 = contact1;
            Contact2 = contact2;
            PhoneNumber1 = phoneNumber1;
