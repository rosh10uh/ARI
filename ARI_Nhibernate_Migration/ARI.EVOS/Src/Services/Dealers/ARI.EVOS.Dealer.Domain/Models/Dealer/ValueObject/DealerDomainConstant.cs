namespace ARI.EVOS.Dealer.Domain.Models.Dealer.ValueObject
{
    ...
    /// </summary>
    public class DealerDomainConstant
    {
        ...
        //Fax validation
        public const string FaxValidateNotUk = "Fax number should be 12 for non UK countries.";
        public const string FaxValidateUk = "Fax number should be 25 for non UK countries.";
        //Phone validations
        public const string PhoneUkValidation = "Please enter valid phone number for the UK.";
