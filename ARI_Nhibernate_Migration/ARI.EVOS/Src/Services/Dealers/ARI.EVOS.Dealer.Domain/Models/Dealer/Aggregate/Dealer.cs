...
namespace ARI.EVOS.Dealer.Domain.Models.Dealer.Aggregate
{
    ...
    public class Dealer : AggregateRoot<int>
    {
        ...
        public virtual void SetDealerInfo(string comment, Program creationProgram, DateTime creationDate, DateTime lastUsed, Program lastProgram, DateTime lastChg, string keyDealerClient, string keyDealerDiv, int? rebateVolumeFactory, int? rebateVolumeStock, float? uKCommission)
        {
            Comment = comment;
