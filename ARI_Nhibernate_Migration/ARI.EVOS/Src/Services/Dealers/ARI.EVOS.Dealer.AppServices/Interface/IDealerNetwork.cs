...
namespace ARI.EVOS.Dealer.AppServices.Interface
{
    ...
    public interface IDealerNetwork
    {
        ...
        Task<Result<string>> SaveEmail(ContactEmailModel additionalEmailContactsModel);
        ...
        Task<Maybe<IEnumerable<DealerNetworkModel>>> GetDealerNetwork(DealerNetworkModel dealerModel);
