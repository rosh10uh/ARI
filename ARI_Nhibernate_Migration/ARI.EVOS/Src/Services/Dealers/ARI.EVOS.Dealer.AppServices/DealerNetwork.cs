...
namespace ARI.EVOS.Dealer.AppServices
{
    ...
    public class DealerNetwork : BaseAppService, IDealerNetwork
    {
        ...
        /// <returns></returns>
        public Task<Result<string>> SaveEmail(ContactEmailModel additionalEmailModel)
        {
            return DispatchCommand<ContactEmailCommand, string>(additionalEmailModel);
        }
        ...
        public Task<Maybe<IEnumerable<DealerNetworkModel>>> GetDealerNetwork(DealerNetworkModel dealerModel)
        {
            return DispatchQuery(new GetDealerQuery(dealerModel.CountryCode, dealerModel.MakeCode, dealerModel.DealerId));
