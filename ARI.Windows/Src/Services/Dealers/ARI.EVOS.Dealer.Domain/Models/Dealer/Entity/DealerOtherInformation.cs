...
namespace ARI.EVOS.Dealer.Domain.Models.Dealer.Entity
{
    ...
    public class DealerOtherInformation : Entity<int>
    {
        ...
        public void SetOtherInformation(string manufactureZoneCode, string printDealerDraft, string draftAccount1, string draftAccount2, string taxId, string overrideTerms)
        {
        ...
        public void SetDealerInfo(string paytoVendor, int? factoryCount, int? stockCount, string courtesyDelivery, string certification)
        {
